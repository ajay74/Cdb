...
namespace Courby.Core
{
    public static class AddressType
    {
        ...
        /// <returns></returns>
        public static int Add(string addressTypeName)
        {
            return Courby.Data.Connection.ExecuteProcedureNonQuery
        ...
        /// <param name="addressTypeName"></param>
        /// <returns></returns>
        public static int Delete(string addressTypeName)
        {
            return Courby.Data.Connection.ExecuteProcedureNonQuery
                ("DeleteAddressType",
        ...
        /// <returns></returns>
        public static int Delete(int addressTypeId)
        {
            return Courby.Data.Connection.ExecuteProcedureNonQuery
                ("DeleteAddressType",
        ...
        /// </summary>
        /// <returns></returns>
        public static System.Data.SqlClient.SqlDataReader GetAddressTypes()
        {
            return Courby.Data.Connection.ExecuteProcedure("GetAddressTypes");
        }
